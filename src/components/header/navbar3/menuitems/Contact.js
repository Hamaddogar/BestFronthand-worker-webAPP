            ...
            {({ TransitionProps, placement }) => (
              ...
              >
                <Paper onMouseOut={this.handleClose} className="extras2-dropdown-r">
                  ...
                  >
                    <MenuList>
                      <MenuItem className="extras2-links-r" onMouseOver={this.handleToggle} onClick={this.handleClose}>Layout 1</MenuItem>
                      <MenuItem className="extras2-links-r" onMouseOver={this.handleToggle} onClick={this.handleClose}>Layout 2</MenuItem>
                    </MenuList>
                  </ClickAwayListener>
                </Paper>
              </Grow>
